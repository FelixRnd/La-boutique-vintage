...
btn_envoyerFormulaire.addEventListener("click", (e) => {
    ...
    function prenomControle() {
        const verifPrenom = contact.prenom
    ...
    function adresseControle() {
        const verifAdresse = contact.adresse
    ...
    function codePostalControle() {
        const verifCodePostal = contact.codePostal
    ...
    function villeControle() {
        const verifVille = contact.ville
    ...
    /*
    const promise01 = fetch("https://la-boutique-vintage.herokuapp.com/api/cameras", {
                    method: "POST",
                    headers: {
    ...
    */
    ...
    let products = [];
    for (listId of produitLocalStorage) {
        products.push(listId.id);
        //console.log(listId)
    }

    //localStorage.setItem("order", JSON.stringify(valuEnregistrer));


    fetch("https://la-boutique-vintage.herokuapp.com/api/cameras/order", {
        method: "POST",
        headers: {
...
const dataLocalStorage = localStorage.getItem("form")
